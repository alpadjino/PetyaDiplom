...
@user_router.post("/invite_to_group", summary="Invite User to Group", response_model=UserOut)
...
@user_router.get("/get_all_user_groups", summary="Get all user groups", response_model=list)
